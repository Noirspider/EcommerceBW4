        ...
        <div class="row g-0 d-flex">
            ...
            <div class="col-md-9">
                <div class="card-body">
                    ...
                    <p class="m-0"> <asp:Label ID="Descrizione" class="card-text text-dark" runat="server"></asp:Label></p>
                    ...
                    <div id="DescrizioneEstesaDiv" runat="server" style="display: none;">
                         <p class="m-0"><asp:Label ID="DescrizioneEstesa" class="card-text text-dark" runat="server"></asp:Label></p>
                    </div>
                    ...
                    <p class="mt-2 text-dark">Quantità disponibile: <br /><asp:Label ID="QuantitaDisponibile" class="card-text text-dark" runat="server"></asp:Label></p>
